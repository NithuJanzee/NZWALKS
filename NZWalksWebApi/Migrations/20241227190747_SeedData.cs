    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("81a82d74-5f66-4c91-9cc3-028f57c92f14"), "Hard" },
                    { new Guid("93f5aea2-5c83-44f4-b5ca-63f03860977f"), "Medium" },
                    { new Guid("95c94607-51d5-49e9-ad0a-070109fef1d1"), "Easy" }
                });

            migrationBuilder.InsertData(
                table: "regions",
                columns: new[] { "Id", "Code", "FullName", "ImageUrl" },
                values: new object[,]
                {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "difficulties",
                keyColumn: "ID",
                keyValue: new Guid("81a82d74-5f66-4c91-9cc3-028f57c92f14"));

            migrationBuilder.DeleteData(
                table: "difficulties",
                keyColumn: "ID",
                keyValue: new Guid("93f5aea2-5c83-44f4-b5ca-63f03860977f"));

            migrationBuilder.DeleteData(
                table: "difficulties",
                keyColumn: "ID",
                keyValue: new Guid("95c94607-51d5-49e9-ad0a-070109fef1d1"));
